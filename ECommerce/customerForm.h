...
private:
  System::Windows::Forms::FlowLayoutPanel ^ flpHistory;
...
#pragma region Windows Form Designer generated code
  void InitializeComponent(void) {
      ...
      this->flpHistory = (gcnew System::Windows::Forms::FlowLayoutPanel());
      ...
      this->btnRequestRefund = (gcnew System::Windows::Forms::Button());
      ...
      this->tabControl->SelectedIndexChanged += gcnew System::EventHandler(this, &customerForm::tabControl_SelectedIndexChanged);
      // 
      // tabCatalog
      // 
      ...
      this->lblCatalogTitle->Font = (gcnew System::Drawing::Font(L"Segoe UI", 14, System::Drawing::FontStyle::Bold));
      ...
      this->txtSearch->TextChanged += gcnew System::EventHandler(this, &customerForm::txtSearch_TextChanged);
      // 
      // dgvProducts
      // 
      ...
      this->btnRefreshCatalog->Click += gcnew System::EventHandler(this, &customerForm::btnRefreshCatalog_Click);
      // 
      // lblQuantity
      // 
      ...
      this->nudQuantity->Minimum = System::Decimal(gcnew cli::array< System::Int32 >(4) { 1, 0, 0, 0 });
      this->nudQuantity->Name = L"nudQuantity";
      this->nudQuantity->Size = System::Drawing::Size(60, 20);
      this->nudQuantity->TabIndex = 4;
      this->nudQuantity->Value = System::Decimal(gcnew cli::array< System::Int32 >(4) { 1, 0, 0, 0 });
      // 
      // btnAddToCart
      // 
      ...
      this->btnAddToCart->Click += gcnew System::EventHandler(this, &customerForm::btnAddToCart_Click);
      // 
      // lblSaldoInfo
      // 
      ...
      this->lblCartTitle->Font = (gcnew System::Drawing::Font(L"Segoe UI", 14, System::Drawing::FontStyle::Bold));
      ...
      this->btnRemoveFromCart->Click += gcnew System::EventHandler(this, &customerForm::btnRemoveFromCart_Click);
      // 
      // lblCartTotal
      // 
      ...
      // panelSummary
      // 
      this->panelSummary->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(245)), static_cast<System::Int32>(static_cast<System::Byte>(247)),
      ...
      this->lblSummaryTitle->Font = (gcnew System::Drawing::Font(L"Segoe UI", 12, System::Drawing::FontStyle::Bold));
      ...
      this->lblGrandTotal->Font = (gcnew System::Drawing::Font(L"Segoe UI", 13, System::Drawing::FontStyle::Bold));
      this->lblGrandTotal->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(46)), static_cast<System::Int32>(static_cast<System::Byte>(125)),
          static_cast<System::Int32>(static_cast<System::Byte>(50)));
      ...
      this->btnCheckout->Click += gcnew System::EventHandler(this, &customerForm::btnCheckout_Click);
      // 
      // lblAlamatCheckout
      // 
      this->lblAlamatCheckout->AutoSize = true;
      this->lblAlamatCheckout->Font = (gcnew System::Drawing::Font(L"Segoe UI", 9, System::Drawing::FontStyle::Bold));
      ...
      // txtAlamatCheckout
      // 
      this->txtAlamatCheckout->Font = (gcnew System::Drawing::Font(L"Segoe UI", 9));
      ...
      this->rbRegular->Font = (gcnew System::Drawing::Font(L"Segoe UI", 9, System::Drawing::FontStyle::Bold));
      ...
      this->rbRegular->CheckedChanged += gcnew System::EventHandler(this, &customerForm::rbExpress_CheckedChanged);
      // 
      // rbExpress
      // 
      this->rbExpress->AutoSize = true;
      this->rbExpress->Font = (gcnew System::Drawing::Font(L"Segoe UI", 9, System::Drawing::FontStyle::Bold));
      ...
      this->rbExpress->CheckedChanged += gcnew System::EventHandler(this, &customerForm::rbExpress_CheckedChanged);
      // 
      // lblPilihKurir
      // 
      ...
      // cmbExpressCourier
      // 
      this->cmbExpressCourier->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
      this->cmbExpressCourier->Font = (gcnew System::Drawing::Font(L"Segoe UI", 9));
      ...
      this->lblSaldoCheckout->Font = (gcnew System::Drawing::Font(L"Segoe UI", 11, System::Drawing::FontStyle::Bold));
      this->lblSaldoCheckout->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(46)), static_cast<System::Int32>(static_cast<System::Byte>(125)),
          static_cast<System::Int32>(static_cast<System::Byte>(50)));
      ...
      this->tabHistory->Controls->Add(this->flpHistory);
      ...
      this->tabHistory->Controls->Add(this->btnRequestRefund);
      ...
      this->flpHistory->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(245)), static_cast<System::Int32>(static_cast<System::Byte>(247)),
          static_cast<System::Int32>(static_cast<System::Byte>(250)));
      this->flpHistory->Location = System::Drawing::Point(15, 50);
      this->flpHistory->Name = L"flpHistory";
      this->flpHistory->Size = System::Drawing::Size(820, 351);
      ...
      this->btnRefreshHistory->Click += gcnew System::EventHandler(this, &customerForm::btnRefreshHistory_Click);
      // 
      // btnConfirmReceived
      // 
      ...
      this->btnConfirmReceived->Click += gcnew System::EventHandler(this, &customerForm::btnConfirmReceived_Click);
      // 
      // btnCancelOrder
      // 
      ...
      this->btnCancelOrder->Click += gcnew System::EventHandler(this, &customerForm::btnCancelOrder_Click);
      // 
      // btnRequestRefund
      // 
      this->btnRequestRefund->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(245)),
      ...
      this->btnRequestRefund->FlatAppearance->BorderSize = 0;
      this->btnRequestRefund->Font = (gcnew System::Drawing::Font(L"Segoe UI", 9, System::Drawing::FontStyle::Bold));
      this->btnRequestRefund->ForeColor = System::Drawing::Color::White;
      this->btnRequestRefund->Location = System::Drawing::Point(410, 411);
      this->btnRequestRefund->Name = L"btnRequestRefund";
      this->btnRequestRefund->Size = System::Drawing::Size(120, 30);
      this->btnRequestRefund->TabIndex = 14;
      this->btnRequestRefund->Text = L"Ajukan Refund";
      this->btnRequestRefund->UseVisualStyleBackColor = false;
      this->btnRequestRefund->Click += gcnew System::EventHandler(this, &customerForm::btnRequestRefund_Click);
      // 
      // tabProfile
      // 
      ...
      this->lblSaldoTitle->Font = (gcnew System::Drawing::Font(L"Segoe UI", 14, System::Drawing::FontStyle::Bold));
      ...
      // txtTopUpAmount
      // 
      this->txtTopUpAmount->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12));
      ...
      this->btnTopUp->Click += gcnew System::EventHandler(this, &customerForm::btnTopUp_Click);
      // 
      // lblProfileTitle
      // 
      ...
      this->btnSaveAlamat->Click += gcnew System::EventHandler(this, &customerForm::btnSaveAlamat_Click);
      // 
      // lblAlamatInfo
      // 
...
private:
  ...
  void LoadCatalog();
  void LoadHistory();
  System::Void HistoryRadioButton_CheckedChanged(System::Object ^ sender,
                                                 System::EventArgs ^ e);
  void LoadSaldo();
  void LoadProfile();
