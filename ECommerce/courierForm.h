...
#pragma region Windows Form Designer generated code
  void InitializeComponent(void) {
    ...
    this->btnWithdraw->Click +=
        gcnew System::EventHandler(this, &courierForm::btnWithdraw_Click);
    //
    // btnRefreshDashboard
    //
...
private:
  ...
  // Grouped delivery FlowLayoutPanels (created dynamically)
private:
  System::Windows::Forms::FlowLayoutPanel ^ flowPending;
  System::Windows::Forms::FlowLayoutPanel ^ flowActive;
  System::Windows::Forms::FlowLayoutPanel ^ flowHistory;

  // Helper functions for grouped cards
  void RenderGroupedCards(FlowLayoutPanel ^ flow, DataTable ^ dt,
                          String ^ actionText, int actionMode);
  void btnGroupAction_Click(System::Object ^ sender, System::EventArgs ^ e);
  int currentSaldo;
