...
#pragma region Windows Form Designer generated code
  void InitializeComponent(void) {
    ...
    this->lblTodayDeliveries->Font =
        (gcnew System::Drawing::Font(L"Segoe UI", 14));
    this->lblTodayDeliveries->Location = System::Drawing::Point(30, 80);
    this->lblTodayDeliveries->Name = L"lblTodayDeliveries";
    this->lblTodayDeliveries->Size = System::Drawing::Size(200, 25);
    ...
    this->lblTotalDeliveries->Font =
        (gcnew System::Drawing::Font(L"Segoe UI", 14));
    this->lblTotalDeliveries->Location = System::Drawing::Point(30, 120);
    this->lblTotalDeliveries->Name = L"lblTotalDeliveries";
    this->lblTotalDeliveries->Size = System::Drawing::Size(180, 25);
    ...
    this->btnRefreshDashboard->Click += gcnew System::EventHandler(
        this, &courierForm::btnRefreshDashboard_Click);
    //
    // tabPending
    //
    ...
    this->tabPending->Size = System::Drawing::Size(752, 454);
    ...
    this->lblPendingTitle->Font = (gcnew System::Drawing::Font(
        L"Segoe UI", 14, System::Drawing::FontStyle::Bold));
    this->lblPendingTitle->Location = System::Drawing::Point(15, 15);
    this->lblPendingTitle->Name = L"lblPendingTitle";
    this->lblPendingTitle->Size = System::Drawing::Size(230, 25);
    ...
    this->dgvPending->AutoSizeColumnsMode =
        System::Windows::Forms::DataGridViewAutoSizeColumnsMode::Fill;
    this->dgvPending->ColumnHeadersHeightSizeMode = System::Windows::Forms::
    ...
    this->dgvPending->SelectionMode =
        System::Windows::Forms::DataGridViewSelectionMode::FullRowSelect;
    this->dgvPending->Size = System::Drawing::Size(720, 320);
    this->dgvPending->TabIndex = 1;
    //
    // btnRefreshPending
    //
    this->btnRefreshPending->Location = System::Drawing::Point(15, 380);
    ...
    this->btnRefreshPending->Click +=
        gcnew System::EventHandler(this, &courierForm::btnRefreshPending_Click);
    //
    // btnClaim
    //
    this->btnClaim->BackColor = System::Drawing::Color::LightGreen;
    this->btnClaim->Font = (gcnew System::Drawing::Font(
        L"Microsoft Sans Serif", 8.25F, System::Drawing::FontStyle::Bold));
    this->btnClaim->Location = System::Drawing::Point(125, 380);
    ...
    this->btnClaim->Click +=
        gcnew System::EventHandler(this, &courierForm::btnClaim_Click);
    //
    // tabActive
    //
    ...
    this->tabActive->Size = System::Drawing::Size(752, 454);
    ...
    this->lblActiveTitle->Font = (gcnew System::Drawing::Font(
        L"Segoe UI", 14, System::Drawing::FontStyle::Bold));
    this->lblActiveTitle->Location = System::Drawing::Point(15, 15);
    this->lblActiveTitle->Name = L"lblActiveTitle";
    this->lblActiveTitle->Size = System::Drawing::Size(180, 25);
    ...
    this->dgvActive->AutoSizeColumnsMode =
        System::Windows::Forms::DataGridViewAutoSizeColumnsMode::Fill;
    this->dgvActive->ColumnHeadersHeightSizeMode = System::Windows::Forms::
        DataGridViewColumnHeadersHeightSizeMode::AutoSize;
    ...
    this->dgvActive->SelectionMode =
        System::Windows::Forms::DataGridViewSelectionMode::FullRowSelect;
    this->dgvActive->Size = System::Drawing::Size(720, 320);
    this->dgvActive->TabIndex = 1;
    //
    // btnRefreshActive
    //
    this->btnRefreshActive->Location = System::Drawing::Point(15, 380);
    ...
    this->btnRefreshActive->Click +=
        gcnew System::EventHandler(this, &courierForm::btnRefreshActive_Click);
    //
    // btnComplete
    //
    this->btnComplete->BackColor = System::Drawing::Color::LightBlue;
    this->btnComplete->Font = (gcnew System::Drawing::Font(
        L"Microsoft Sans Serif", 8.25F, System::Drawing::FontStyle::Bold));
    this->btnComplete->Location = System::Drawing::Point(125, 380);
    ...
    this->btnComplete->Click +=
        gcnew System::EventHandler(this, &courierForm::btnComplete_Click);
    //
    // tabHistory
    //
    ...
    this->btnRefreshHistory->Click +=
        gcnew System::EventHandler(this, &courierForm::btnRefreshHistory_Click);
    //
    // btnLogout
    //
    ...
    this->btnLogout->Click +=
        gcnew System::EventHandler(this, &courierForm::btnLogout_Click);
    //
    // courierForm
    //
    ...
    this->Load +=
        gcnew System::EventHandler(this, &courierForm::courierForm_Load);
