...
#pragma region Windows Form Designer generated code
  void InitializeComponent(void) {
      ...
      this->lblTotalTransactions->Location = System::Drawing::Point(450, 110);
      ...
      this->lblTotalIncome->Location = System::Drawing::Point(450, 140);
      ...
      // btnRefreshStats
      // 
      this->btnRefreshStats->Location = System::Drawing::Point(30, 220);
      this->btnRefreshStats->Name = L"btnRefreshStats";
      this->btnRefreshStats->Size = System::Drawing::Size(120, 30);
...
private:
  System::Void btnActivateUser_Click(System::Object ^ sender,
    ...
    int userID =
        Convert::ToInt32(dgvUsers->SelectedRows[0]->Cells["ID"]->Value);
...
private:
  System::Void btnDeactivateUser_Click(System::Object ^ sender,
    ...
    if (MessageBox::Show("Are you sure you want to deactivate user '" +
                             username + "'?",
...
private: System::Void tabDashboard_Click(System::Object^ sender, System::EventArgs^ e) {
}
};
} // namespace ECommerce
